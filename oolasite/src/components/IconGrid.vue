...
const activeSize = ref<(typeof SIZES)[number]>(48);
const page = ref(1);
  ...
  <section id="drafts" class="oola-section">
    <header class="oola-section-head">
      ...
      <p>
        ...
        <code>layout-grid</code>) mark the style anchors. The default view is
        the quality-locked Batch 100 for review; switch to All for the full
        catalog. {{ PAGE_SIZE }} per page; six weights plus a Light-based
        motion preview.
      </p>
    </header>
