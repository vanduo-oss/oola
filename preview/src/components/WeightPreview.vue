...
const activeIcon = ref<IconName>("heart");
const filter = ref("");
...
<template>
  <section id="weights" class="oola-section">
    <header class="oola-section-head">
      <h2>Icon weights</h2>
      <p>
        Six distinct weights for different visual styles — same glyph,
        preview-only transforms (like vd3). Filter or pick a glyph.
      </p>
    </header>
